...
function App() {
  ...
  const skills = [
    { img: html, name: 'HTML5', level: 'Expart' },
    { img: css, name: 'CSS3', level: 'Comfortable' },
    { img: tailwind, name: 'Tailwind Css', level: 'Expart' },
    { img: bootstrap, name: 'Bootstrap', level: 'Expart' },
    { img: js, name: 'JavaScript', level: 'Comfortable' },
    { img: react, name: 'React', level: 'Expart' },
    { img: node, name: 'NodeJs', level: 'Comfortable' },
    { img: ex, name: 'Express Js', level: 'Comfortable' },
    { img: mongo, name: 'MongoDb', level: 'Comfortable' },
    { img: redux, name: 'Redux', level: 'Comfortable' },
    { img: next, name: 'Next JS', level: 'Familiar' },
    { img: ts, name: 'TypeScript', level: 'Familiar' },
      ...
      <section name='intro' className='relative'>
        ...
        <div className="navbar bg-base-200 mb-10 md:mb-0">
          <div className="navbar-start">
            ...
            <a className=" text-3xl font-bold text-white">Abir's Prorfolio</a>
          </div>
