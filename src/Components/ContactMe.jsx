                            ...
                            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                                <div className='space-y-5'>
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <p><a className='link-hover' href="mailto:md.tazwarul.islam.07@gmail.com">md.tazwarul.islam.07@gmail.com</a></p>
                                    </div>
                                    <div className='flex items-center gap-4'>
                                ...
                                <div className='space-y-5'>
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <p><a href="https://www.facebook.com/tazwarul.islam" className='link-hover'>Facebook</a></p>
                                    </div>
                                    <div className='flex items-center gap-4'>
                                        <FaGithubSquare className='text-xl text-white' />
                                        <p>
                                            <a href="https://github.com/Abir-7" className='link-hover'>GitHub</a>
                                        </p>
                                    </div>
                                    <div className='flex items-center gap-4'>
                                        <FaLinkedin className='text-xl text-white'></FaLinkedin>
                                        <p>
                                            <a href="https://www.linkedin.com/in/md-tazwarul-islam-abir-5762b7214/" className='link-hover'>LinkedIn</a>
                                        </p>
                                    </div>
